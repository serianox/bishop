...
const option = p.alt(p.seq(indent, identifier, whitespace, equal, remainder).map(_ => new Option(_[1], _[4])), p.seq(indent, identifier, whitespace).map(_ => new Option(_[1], "true")));
